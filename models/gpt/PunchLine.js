...
async function main(
    ...
    const citation = "Le combat des idées se fait ensemblre avec des gants de box CONTRE Emmanuel Macron, le champion du monde de l'Escroquerie Moral'! 🥊🇫🇷";
    ...
    const outputFilePath =
      "output/🥊-PunchLine68🇫🇷_" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".md";
